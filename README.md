...
[![Test](https://github.com/NpoolPlatform/gas-feeder/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/gas-feeder/actions/workflows/main.yml)
...
* make gas-feeder ```单独编译服务```
* make gas-feeder-image ```单独生成服务镜像```
