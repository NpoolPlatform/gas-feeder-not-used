module github.com/NpoolPlatform/gas-feeder
...
require (
	...
	github.com/NpoolPlatform/libent-cruder v0.0.0-20220606031915-f9665b4ff898
	github.com/NpoolPlatform/message v0.0.0-20220606025826-a2703675effd
